...
def mainProc():
    ...
    groupName['group' + txt[:4]] = [
        ...
        final_scores, frequencies, scores_0, scores_1, scores_2, scores_3,
        scores_4, mean, std
    ]
...
def barChart2Plotting():
    print('Now plotting bar chart 2.')
    ...
    for txt in txtFiles:
        final_score_bar2.add(
            "Mean " + txt[:4], groupList[txtFiles.index(txt)][11])
        final_score_bar2.add(
            "STD " + txt[:4], groupList[txtFiles.index(txt)][12])
